...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/NBLoadableFromXibView/NBLoadableFromXibView.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/TLCityPicker/TLCityPicker.framework"
