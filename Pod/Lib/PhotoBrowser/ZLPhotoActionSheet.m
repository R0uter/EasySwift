...
- (void)showWithSender:(UIViewController *)sender window:(UIWindow *)window animate:(BOOL)animate completion:(void (^)(NSArray<UIImage *> *selectPhotos))completion
{
...
- (void)show
{
    ...
    if (_animate) {
        CGPoint fromPoint = CGPointMake(kViewWidth/2, kViewHeight);
